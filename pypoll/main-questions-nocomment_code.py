#Final Questions
# 1. How to account for accidental duplicate voting (as commented below?)
# 2. Is there a way to make the code run faster? Seems to lag when trying to calculate the Total Votes
